...
public class Phycology1 extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    Spinner doctorone;
TextView dname,dob,daddress,daddres;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_phycology1);
      doctorone=findViewById(R.id.p_spiner1);
dname=findViewById(R.id.rdname1);
dob=findViewById(R.id.dob1);
daddress=findViewById(R.id.daddress1);
daddres=findViewById(R.id.daddres1);
...
//Toast.makeText(Recharge.this, "your new balnce is "+ba, Toast.LENGTH_LONG).show();
                        ...
                        ArrayAdapter spinnerArrayAdapter = new ArrayAdapter(Phycology1.this, R.layout.support_simple_spinner_dropdown_item, names);
...
// balance.setText(m+"");
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(Phycology1.this);
